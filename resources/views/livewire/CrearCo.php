        ...
        <div class="relative sm:max-w-sm w-full">
            ...
            <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                ...
                <form action="" >
                    ...
                    <div>
                        <input type="text" placeholder="Nombre del proveedor" class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"id="nombre_proveedor" wire:model="nombre_proveedor">
                    </div>
        
                    <div class="mt-7">                
                        <input type="number" placeholder="Cantidad de insumo" class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" id="cantidad_insumo" wire:model="cantidad_insumo">                           
                    </div>
